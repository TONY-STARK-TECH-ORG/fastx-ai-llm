    ...
    },
    {
        ...
        children: [
            ...
            { key: '/dashboard/tool/llm-function', label: '输入输出预处理' },
            {
                ...
                label: '模型微调工具',
                children: [
                    { key: '/dashboard/tool/train/train-dataset', label: '数据预处理' },
                    { key: '/dashboard/tool/train/train-hyperParams', label: '训练参数以及策略' },
                    { key: '/dashboard/tool/train/train-post', label: '模型后处理' },
                    { key: '/dashboard/tool/train/train-upload', label: '模型上传/下载' },
                    { key: '/dashboard/tool/train/train-benchmark', label: '模型评测' },
                    { key: '/dashboard/tool/train/train-tokenizer', label: '数据向量化' },
                    { key: '/dashboard/tool/train/train-finetune', label: '模型微调' }
                ],
            },
        ],
    },
