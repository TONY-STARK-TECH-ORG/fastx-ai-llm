...
export default function LLM_FunctionNode(props: NodeProps<LLM_ModelNode>) {
    ...
    return (
        <div className={
            ...
            {tool?.code === 'llm.start' ? (
                <div className="p-1">
                    <p className="text-[8px] text-gray-400">开始节点</p>
                </div>
            ) : null}
            {tool?.code === 'llm.end' ? (
                <div className="p-1">
                    <p className="text-[8px] text-gray-400">完成节点</p>
                </div>
            ) : null}
