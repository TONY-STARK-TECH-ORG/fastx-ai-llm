package com.fastx.ai.llm.common;
...
public class SnowflakeIdGenerator {
    ...
    // Company's epoch = Monday, January 1, 2024 12:00:00 AM
    ...
    public SnowflakeIdGenerator() {
        ...
        // machineId need larger than datacenterId
        this.datacenterId = 0;
        this.machineId = 1;
    }
    ...
    private long waitForNextMillis(long lastTimestamp) {
        ...
        while (timestamp <= lastTimestamp) {
            try {
                // Wait for existing thread wait count + 1 millisecond
        ...
        // Clean up the wait count for the past timestamp
